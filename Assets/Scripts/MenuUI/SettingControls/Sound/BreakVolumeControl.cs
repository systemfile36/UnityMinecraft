...
public class BreakVolumeControl : SettingControl
{
    public override bool IsChanged
    {
        get
        {
            ...
            if (Mathf.Approximately(
                ...
                GameManager.Mgr.settings.breakedVolume))
            {
                return true;
            }
            else
    ...
    public override void ApplyToSettings(ref Settings set)
    {
        ...
        set.breakedVolume = Mathf.Clamp01((float)Math.Round(sliderControl.slider.value / 100, 2));
    }
    ...
    public override void SetSettingValue(ref Settings set)
    {
        ...
        sliderControl.slider.value = set.breakedVolume * 100;
    }
}
