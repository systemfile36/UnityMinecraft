...
public class StepPitchControl : SettingControl
{
    public override bool IsChanged
    {
        get
        {
            ...
            if (Mathf.Approximately(
                ...
                GameManager.Mgr.settings.stepPitch))
            {
                return true;
            }
            else
    ...
    public override void ApplyToSettings(ref Settings set)
    {
        ...
        set.stepPitch = Mathf.Clamp01((float)Math.Round(sliderControl.slider.value / 100, 2));
    }
    ...
    public override void SetSettingValue(ref Settings set)
    {
        ...
        sliderControl.slider.value = set.stepPitch * 100;
    }
}
