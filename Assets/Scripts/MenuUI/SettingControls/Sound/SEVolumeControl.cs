...
public class SEVolumeControl : SettingControl
{
    ...
    public override void ApplyToSettings(ref Settings set)
    {
        ...
        set.seVolume = Mathf.Clamp01((float)Math.Round(sliderControl.slider.value / 100, 2));
    }
    ...
    public override void SetSettingValue(ref Settings set)
    {
        ...
        sliderControl.slider.value = set.seVolume * 100;
    }
